...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/cm/shared/user/data/cpa_data/voc_hybrid_dark/train/ImageSets/Main/train_voc.txt",
        data_prefix=dict(sub_data_root="/cm/shared/user/data/cpa_data/voc_hybrid_dark/train"),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=dict(classes=classes),
        ann_file="/cm/shared/user/data/cpa_data/voc_dark/test/ImageSets/Main/test_voc.txt",
        data_prefix=dict(sub_data_root="/cm/shared/user/data/cpa_data/voc_dark/test"),
        test_mode=True,
